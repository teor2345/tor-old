...
/* Return 1 iff the given <b>digest</b> matches the digest in the origin
 * circuit <b>ocirc</b> of its rend data . If the rend data doesn't exist, 0
 * is returned. This function is agnostic to the rend data version. */
int
rend_circuit_matches_digest(const origin_circuit_t *ocirc,
