...
typedef enum {
  ...
  BOOTSTRAP_STATUS_LOADING_KEYS=30,
  BOOTSTRAP_STATUS_REQUESTING_DESCRIPTORS=35,
  BOOTSTRAP_STATUS_LOADING_DESCRIPTORS=-3,
  BOOTSTRAP_STATUS_CIRCUIT_CREATE=-4,
  BOOTSTRAP_STATUS_LOADING_DESCRIPTORS_INTERNAL=40,
  /* Map descriptor percentage to 40-49% */
  BOOTSTRAP_STATUS_CONN_OR_INTERNAL=50,
  BOOTSTRAP_STATUS_HANDSHAKE_OR_INTERNAL=55,
  BOOTSTRAP_STATUS_CIRCUIT_CREATE_INTERNAL=60,
  BOOTSTRAP_STATUS_LOADING_DESCRIPTORS_EXIT=70,
  /* Map descriptor percentage to 70-79% */
  BOOTSTRAP_STATUS_CONN_OR_EXIT=80,
  BOOTSTRAP_STATUS_HANDSHAKE_OR_EXIT=85,
  BOOTSTRAP_STATUS_CIRCUIT_CREATE_EXIT=90,
