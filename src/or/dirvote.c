...
dirvote_recalculate_timing(const or_options_t *options, time_t now)
{
  ...
  voting_schedule.interval_starts = new_voting_schedule->interval_starts;
  voting_schedule.fetch_missing_signatures =
    new_voting_schedule->fetch_missing_signatures;
  voting_schedule.voting_ends = new_voting_schedule->voting_ends;
  voting_schedule.fetch_missing_votes = new_voting_schedule->fetch_missing_votes;
  voting_schedule.voting_starts = new_voting_schedule->voting_starts;
