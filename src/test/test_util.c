...
#ifdef _WIN32
/* let's assume Windows doesn't have the gap between fork and exec
 ...
 * to the process_handle's fields
 *
                          ...
                          int expected_status)
{
   ...
   * there is a race condition with the SIGCHLD handler 
   * updating the process_handle's fields.
   * This can occur before or after the code below executes.
