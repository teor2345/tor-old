...
#define WARN_PLEASE_USE_IPV6_DIR_LOG_MSG \
  ...
  tt_int_op(mock_saved_log_position(WARN_PLEASE_USE_IPV6_OR_LOG_MSG), OP_NE,
            MOCK_SAVED_LOG_MSG_NOT_FOUND);
  tor_free(msg);
  ...
  ret = options_validate(tdata->old_opt, tdata->opt, tdata->def_opt, 0, &msg);
  tt_int_op(ret, OP_EQ, 0);
  tt_int_op(mock_saved_log_position(WARN_PLEASE_USE_IPV6_DIR_LOG_MSG), OP_NE,
            MOCK_SAVED_LOG_MSG_NOT_FOUND);
  tor_free(msg);
