...
# Require fallbacks to have the same address and port for at least 6 months.
# (6 months is the expected time between major Tor releases. The fallback
# directory list is regenerated before each major stable Tor release.)
#
...
# for this issue.
ADDRESS_AND_PORT_STABLE_DAYS = 183
...
class Candidate(object):
  ...
  def is_valid_version(self):
    ...
    if not self._data.has_key('version'):
      ...
      return False
    if self._data['recommended_version'] in STALE_CONSENSUS_VERSIONS:
